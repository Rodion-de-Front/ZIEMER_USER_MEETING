...
const dictionaries = {
  ru: {
    language: "EN",
    offline: "Нет подключения к интернету. Доступен ранее загруженный контент.",
    loading: "Загрузка…",
    ...
    sections: "Разделы встречи",
    participant: "Участник",
    search: "Поиск по порталу",
    searchPlaceholder: "Введите ключевое слово…",
    searchEmpty: "Страницы по этому запросу не найдены.",
    searchHint: "Начните вводить, чтобы найти страницу.",
    ...
    pushRequiredText:
      "Для доступа к порталу нужно разрешить push-уведомления. Так организаторы смогут отправлять важные сообщения участникам.",
    pushChecking: "Проверяем статус push-уведомлений…",
    pushSaving: "Подключаем push-уведомления…",
    pushDenied:
      "Уведомления заблокированы. Разрешите их в настройках браузера или приложения, затем вернитесь и нажмите кнопку проверки.",
    pushUnsupported:
      "Этот браузер или устройство не поддерживает push-уведомления для PWA.",
    pushEnable: "Разрешить push-уведомления",
    pushCheckAgain: "Проверить разрешение",
    blocked: "ДОСТУП ОГРАНИЧЕН",
    blockedTitle: "Ваш аккаунт заблокирован",
    blockedText:
      "Обратитесь к организаторам, если считаете, что блокировка произошла по ошибке.",
    login: "Войти",
    ...
    adminSearch: "Поиск: ФИО, почта, город…",
    feedbackInbox: "Отзывы из приложения",
    feedbackEmpty: "Отзывов пока нет.",
    rating: "Оценка",
    emailDuplicated: "Продублировано на почту",
    emailNotSent: "Письмо не отправлено",
    pushCampaign: "Push-рассылка",
    title: "Заголовок",
    text: "Текст",
    sendTime: "Время отправки",
    leaveEmpty: "оставьте пустым для отправки сейчас",
    sendNow: "Отправить сейчас",
    schedule: "Запланировать",
    saving: "Сохранение…",
    history: "Последние кампании",
    sent: "Доставлено",
    scheduled: "Запланирована",
    requestError: "Ошибка запроса",
    offlineError: "Нет подключения к интернету.",
  },
  en: {
    language: "RU",
    ...
    searchEmpty: "No pages match this search.",
    searchHint: "Start typing to find a page.",
    install: "Install app",
    ...
    pushRequiredText:
      "Push notifications are required to access the portal, so organisers can send important messages to participants.",
    pushChecking: "Checking push notification status…",
    pushSaving: "Enabling push notifications…",
    pushDenied:
      "Notifications are blocked. Enable them in your browser or app settings, then return and check again.",
    pushUnsupported:
      "This browser or device does not support push notifications for PWAs.",
    ...
    blockedText:
      "Contact the organisers if you believe your account was blocked by mistake.",
    login: "Sign in",
    ...
    adminSearch: "Search: name, email, city…",
    feedbackInbox: "App feedback",
    feedbackEmpty: "No feedback yet.",
    rating: "Rating",
    emailDuplicated: "Duplicated to email",
    emailNotSent: "Email was not sent",
    pushCampaign: "Push campaign",
    title: "Title",
    text: "Message",
    sendTime: "Send time",
    leaveEmpty: "leave empty to send now",
    sendNow: "Send now",
    schedule: "Schedule",
    saving: "Saving…",
...
export function LanguageProvider({ children }) {
  const [language, setLanguage] = useState(
    () => localStorage.getItem("ziemer-language") || "ru",
  );
  useEffect(() => {
